 ...
 $default_footerlink_liste = array(
     ...
     __('International', 'piratenkleider' ) => array(
      ...
      __('International (mit Flaggen)', 'piratenkleider' ) => array(
         ...
         'url'  => 'http://www.pp-international.net/',
         'sublist' => array(
             '<img src="'.get_template_directory_uri().'/images/flags/ar.png" alt="'.__('Argentinien', 'piratenkleider').'" title="'.__('Argentinien', 'piratenkleider').'">' => 'http://www.partidopirata.com.ar/',
             '<img src="'.get_template_directory_uri().'/images/flags/au.png" alt="'.__('Australien', 'piratenkleider').'" title="'.__('Australien', 'piratenkleider').'">' => 'http://pirateparty.org.au/',
             '<img src="'.get_template_directory_uri().'/images/flags/be.png" alt="'.__('Belgien', 'piratenkleider').'" title="'.__('Belgien', 'piratenkleider').'">' => 'http://pirateparty.be/',
             '<img src="'.get_template_directory_uri().'/images/flags/br.png" alt="'.__('Brasilien', 'piratenkleider').'" title="'.__('Brasilien', 'piratenkleider').'">' => 'http://www.partidopirata.org/',
             '<img src="'.get_template_directory_uri().'/images/flags/bg.png" alt="'.__('Bulgarien', 'piratenkleider').'" title="'.__('Bulgarien', 'piratenkleider').'">' => 'http://piratskapartia.bg/',
             '<img src="'.get_template_directory_uri().'/images/flags/cl.png" alt="'.__('Chile', 'piratenkleider').'" title="'.__('Chile', 'piratenkleider').'">' => 'http://www.partidopirata.cl/',
             '<img src="'.get_template_directory_uri().'/images/flags/dk.png" alt="'.__('D&auml;nemark', 'piratenkleider').'" title="'.__('D&auml;nemark', 'piratenkleider').'">' => 'http://piratpartiet.dk/',
             '<img src="'.get_template_directory_uri().'/images/flags/de.png" alt="'.__('Deutschland', 'piratenkleider').'" title="'.__('Deutschland', 'piratenkleider').'">' => 'http://piratenpartei.de/',
             '<img src="'.get_template_directory_uri().'/images/flags/ee.png" alt="'.__('Estland', 'piratenkleider').'" title="'.__('Estland', 'piratenkleider').'">' => 'http://piraadipartei.ee/',    
             '<img src="'.get_template_directory_uri().'/images/flags/fi.png" alt="'.__('Finnland', 'piratenkleider').'" title="'.__('Finnland', 'piratenkleider').'">' => 'http://www.piraattipuolue.fi/',
             '<img src="'.get_template_directory_uri().'/images/flags/fr.png" alt="'.__('Frankreich', 'piratenkleider').'" title="'.__('Frankreich', 'piratenkleider').'">' => 'http://partipirate.org/',
             '<img src="'.get_template_directory_uri().'/images/flags/gr.png" alt="'.__('Griechenland', 'piratenkleider').'" title="'.__('Griechenland', 'piratenkleider').'">' => 'http://pirateparty.gr/',
             '<img src="'.get_template_directory_uri().'/images/flags/gt.png" alt="'.__('Guatemala', 'piratenkleider').'" title="'.__('Guatemala', 'piratenkleider').'">' => 'http://partidopirata.org.gt/',
             '<img src="'.get_template_directory_uri().'/images/flags/is.png" alt="'.__('Island', 'piratenkleider').'" title="'.__('Island', 'piratenkleider').'">' => 'http://pirateparty.is/',            
             '<img src="'.get_template_directory_uri().'/images/flags/il.png" alt="'.__('Israel', 'piratenkleider').'" title="'.__('Israel', 'piratenkleider').'">' => 'http://piratim.org/',            
             '<img src="'.get_template_directory_uri().'/images/flags/it.png" alt="'.__('Italien', 'piratenkleider').'" title="'.__('Italien', 'piratenkleider').'">' => 'http://www.partito-pirata.it/',
             '<img src="'.get_template_directory_uri().'/images/flags/ca.png" alt="'.__('Kanada', 'piratenkleider').'" title="'.__('Kanada', 'piratenkleider').'">' => 'https://www.pirateparty.ca/',
             '<img src="'.get_template_directory_uri().'/images/flags/kz.png" alt="'.__('Kasachstan', 'piratenkleider').'" title="'.__('Kasachstan', 'piratenkleider').'">' => 'http://pirateparty.kz/',
             '<img src="'.get_template_directory_uri().'/images/flags/co.png" alt="'.__('Kolumbien', 'piratenkleider').'" title="'.__('Kolumbien', 'piratenkleider').'">' => 'http://pp.interlecto.net/',
             '<img src="'.get_template_directory_uri().'/images/flags/hr.png" alt="'.__('Kroatien', 'piratenkleider').'" title="'.__('Kroatien', 'piratenkleider').'">' => 'http://pirati.hr/',
             '<img src="'.get_template_directory_uri().'/images/flags/lv.png" alt="'.__('Lettland', 'piratenkleider').'" title="'.__('Lettland', 'piratenkleider').'">' => 'http://piratupartija.lv/',
             '<img src="'.get_template_directory_uri().'/images/flags/lt.png" alt="'.__('Litauen', 'piratenkleider').'" title="'.__('Litauen', 'piratenkleider').'">' => 'http://piratupartija.lt/',
             '<img src="'.get_template_directory_uri().'/images/flags/lu.png" alt="'.__('Luxemburg', 'piratenkleider').'" title="'.__('Luxemburg', 'piratenkleider').'">' => 'http://www.piratepartei.lu/',
             '<img src="'.get_template_directory_uri().'/images/flags/ma.png" alt="'.__('Marokko', 'piratenkleider').'" title="'.__('Marokko', 'piratenkleider').'">' => 'http://partipirate.ma/',
             '<img src="'.get_template_directory_uri().'/images/flags/mx.png" alt="'.__('Mexiko', 'piratenkleider').'" title="'.__('Mexiko', 'piratenkleider').'">' => 'http://www.partidopiratamexicano.org/',
             '<img src="'.get_template_directory_uri().'/images/flags/nz.png" alt=" '.__('Neuseeland', 'piratenkleider').'" title="'.__('Neuseeland', 'piratenkleider').'">' => 'http://pirateparty.org.nz/',
             '<img src="'.get_template_directory_uri().'/images/flags/nl.png" alt="'.__('Niederlande', 'piratenkleider').'" title="'.__('Niederlande', 'piratenkleider').'">' => 'http://www.piratenpartij.nl/',
             '<img src="'.get_template_directory_uri().'/images/flags/at.png" alt="'.__('&Ouml;sterreich', 'piratenkleider').'" title="'.__('&Ouml;sterreich', 'piratenkleider').'">' => 'http://piratenpartei.at/',
             '<img src="'.get_template_directory_uri().'/images/flags/pe.png" alt="'.__('Peru', 'piratenkleider').'" title="'.__('Peru', 'piratenkleider').'">' => 'http://wiki.freeculture.org/Pirata',
             '<img src="'.get_template_directory_uri().'/images/flags/pl.png" alt="'.__('Polen', 'piratenkleider').'" title="'.__('Polen', 'piratenkleider').'">' => 'http://www.partiapiratow.org.pl/',
             '<img src="'.get_template_directory_uri().'/images/flags/pt.png" alt="'.__('Portugal', 'piratenkleider').'" title="'.__('Portugal', 'piratenkleider').'">' => 'http://www.partidopiratapt.eu/',
             '<img src="'.get_template_directory_uri().'/images/flags/ro.png" alt="'.__('Rum&auml;nien', 'piratenkleider').'" title="'.__('Rum&auml;nien', 'piratenkleider').'">' => 'http://www.partidulpiratilor.ro/',
             '<img src="'.get_template_directory_uri().'/images/flags/ru.png" alt="'.__('Russland', 'piratenkleider').'" title="'.__('Russland', 'piratenkleider').'">' => 'http://pirate-party.ru/',
             '<img src="'.get_template_directory_uri().'/images/flags/se.png" alt="'.__('Schweden', 'piratenkleider').'" title="'.__('Schweden', 'piratenkleider').'">' => 'http://www.piratpartiet.se/',
             '<img src="'.get_template_directory_uri().'/images/flags/ch.png" alt="'.__('Schweiz', 'piratenkleider').'" title="'.__('Schweiz', 'piratenkleider').'">' => 'http://www.piratenpartei.ch/',
             '<img src="'.get_template_directory_uri().'/images/flags/rs.png" alt="'.__('Serbien', 'piratenkleider').'" title="'.__('Serbien', 'piratenkleider').'">' => 'http://www.piratskapartija.com/',
             '<img src="'.get_template_directory_uri().'/images/flags/sk.png" alt="'.__('Slowakei', 'piratenkleider').'" title="'.__('Slowakei', 'piratenkleider').'">' => 'http://www.piratskastrana.sk/',
             '<img src="'.get_template_directory_uri().'/images/flags/si.png" alt="'.__('Slowenien', 'piratenkleider').'" title="'.__('Slowenien', 'piratenkleider').'">' => 'http://www.piratskastranka.net/',
             '<img src="'.get_template_directory_uri().'/images/flags/es.png" alt="'.__('Spanien', 'piratenkleider').'" title="'.__('Spanien', 'piratenkleider').'">' => 'http://www.partidopirata.es/',
             '<img src="'.get_template_directory_uri().'/images/flags/kr.png" alt="'.__('S&uuml;dkorea', 'piratenkleider').'" title="'.__('S&uuml;dkorea', 'piratenkleider').'">' => 'http://pirateparty.kr/',
             '<img src="'.get_template_directory_uri().'/images/flags/cz.png" alt="'.__('Tschechien', 'piratenkleider').'" title="'.__('Tschechien', 'piratenkleider').'">' => 'http://www.ceskapiratskastrana.cz/',
             '<img src="'.get_template_directory_uri().'/images/flags/tn.png" alt="'.__('Tunesien', 'piratenkleider').'" title="'.__('Tunesien', 'piratenkleider').'">' => 'http://partipirate-tn.org/',
             '<img src="'.get_template_directory_uri().'/images/flags/tr.png" alt="'.__('T&uuml;rkei', 'piratenkleider').'" title="'.__('T&uuml;rkei', 'piratenkleider').'">' => 'http://www.korsanpartisi.org/',
             '<img src="'.get_template_directory_uri().'/images/flags/ua.png" alt="'.__('Ukraine', 'piratenkleider').'" title="'.__('Ukraine', 'piratenkleider').'">' => 'http://pp-ua.org/',
             '<img src="'.get_template_directory_uri().'/images/flags/hu.png" alt="'.__('Ungarn', 'piratenkleider').'" title="'.__('Ungarn', 'piratenkleider').'">' => 'http://kalozpart.org/',             
             '<img src="'.get_template_directory_uri().'/images/flags/uy.png" alt="'.__('Uruguay', 'piratenkleider').'" title="'.__('Uruguay', 'piratenkleider').'">' => 'http://partidopirata.org.uy/',
             '<img src="'.get_template_directory_uri().'/images/flags/us.png" alt="'.__('USA', 'piratenkleider').'" title="'.__('USA', 'piratenkleider').'">' => 'http://pirate-party.us/',
             '<img src="'.get_template_directory_uri().'/images/flags/uk.png" alt="'.__('Vereinigtes Königreich', 'piratenkleider').'" title="'.__('Vereinigtes Königreich', 'piratenkleider').'">' => 'http://pirateparty.org.uk/',              
             '<img src="'.get_template_directory_uri().'/images/flags/by.png" alt="'.__('Wei&szlig;russland', 'piratenkleider').'" title="'.__('Wei&szlig;russland', 'piratenkleider').'">' => 'http://pirates.by/',
             '<img src="'.get_template_directory_uri().'/images/flags/cy.png" alt="'.__('Zypern', 'piratenkleider').'" title="'.__('Zypern', 'piratenkleider').'">' => 'http://www.piratepartycyprus.com/',
