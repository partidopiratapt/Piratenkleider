...
$defaultoptions = array(
    ...
    'stickerlink1-content'          => __( '<span class="gedreht">Werde<br><span class="cicolor">Pirat!</span></span>', 'piratenkleider' ),
    'stickerlink1-url'              => 'https://www.piratenpartei.de/mitmachen/mitglied-werden/',
    'stickerlink2-content'          => __( '<span class="gedreht"> <span class="cicolor">Spende</span><br><span class="small">und hilf mit </span> </span>', 'piratenkleider' ),
 ...
 $default_footerlink_liste = array(
     ...
     __('International', 'piratenkleider' ) => array(
      ...
      __('International (mit Flaggen)', 'piratenkleider' ) => array(
         ...
         'url'  => 'http://www.pp-international.net/',
         'sublist' => array(
             '<img src="'.get_template_directory_uri().'/images/flags/ar.png" width="16" height="11" alt=""> '.__('Argentinien', 'piratenkleider') => 'http://www.partidopirata.com.ar/',
             '<img src="'.get_template_directory_uri().'/images/flags/au.png" width="16" height="11" alt=""> '.__('Australien', 'piratenkleider') => 'http://pirateparty.org.au/',
             '<img src="'.get_template_directory_uri().'/images/flags/be.png" width="16" height="11" alt=""> '.__('Belgien', 'piratenkleider') => 'http://pirateparty.be/',
             '<img src="'.get_template_directory_uri().'/images/flags/br.png" width="16" height="11" alt=""> '.__('Brasilien', 'piratenkleider') => 'http://www.partidopirata.org/',
              '<img src="'.get_template_directory_uri().'/images/flags/bg.png" width="16" height="11" alt=""> '.__('Bulgarien', 'piratenkleider') => 'http://piratskapartia.bg/',
              '<img src="'.get_template_directory_uri().'/images/flags/cl.png" width="16" height="11" alt=""> '.__('Chile', 'piratenkleider') => 'http://www.partidopirata.cl/',
              '<img src="'.get_template_directory_uri().'/images/flags/dk.png" width="16" height="11" alt=""> '.__('D&auml;nemark', 'piratenkleider') => 'http://piratpartiet.dk/',
              '<img src="'.get_template_directory_uri().'/images/flags/de.png" width="16" height="11" alt=""> '.__('Deutschland', 'piratenkleider') => 'http://piratenpartei.de/',
              '<img src="'.get_template_directory_uri().'/images/flags/uk.png" width="16" height="11" alt=""> '.__('England', 'piratenkleider') => 'http://pirateparty.org.uk/',             
              '<img src="'.get_template_directory_uri().'/images/flags/fi.png" width="16" height="11" alt=""> '.__('Finnland', 'piratenkleider') => 'http://www.piraattipuolue.fi/',
              '<img src="'.get_template_directory_uri().'/images/flags/fr.png" width="16" height="11" alt=""> '.__('Frankreich', 'piratenkleider') => 'http://partipirate.org/',
              '<img src="'.get_template_directory_uri().'/images/flags/gr.png" width="16" height="11" alt=""> '.__('Griechenland', 'piratenkleider') => 'http://pirateparty.gr/',
              '<img src="'.get_template_directory_uri().'/images/flags/gt.png" width="16" height="11" alt=""> '.__('Guatemala', 'piratenkleider') => 'http://partidopirata.org.gt/',
              '<img src="'.get_template_directory_uri().'/images/flags/it.png" width="16" height="11" alt=""> '.__('Italien', 'piratenkleider') => 'http://www.partito-pirata.it/',
              '<img src="'.get_template_directory_uri().'/images/flags/ca.png" width="16" height="11" alt=""> '.__('Kanada', 'piratenkleider') => 'http://www.piratepartyofcanada.com/',
              '<img src="'.get_template_directory_uri().'/images/flags/kz.png" width="16" height="11" alt=""> '.__('Kasachstan', 'piratenkleider') => 'http://pirateparty.kz/',
              '<img src="'.get_template_directory_uri().'/images/flags/co.png" width="16" height="11" alt=""> '.__('Kolumbien', 'piratenkleider') => 'http://pp.interlecto.net/',
              '<img src="'.get_template_directory_uri().'/images/flags/lv.png" width="16" height="11" alt=""> '.__('Lettland', 'piratenkleider') => 'http://piratupartija.lv/',
              '<img src="'.get_template_directory_uri().'/images/flags/lt.png" width="16" height="11" alt=""> '.__('Litauen', 'piratenkleider') => 'http://piratupartija.lt/',
              '<img src="'.get_template_directory_uri().'/images/flags/lu.png" width="16" height="11" alt=""> '.__('Luxemburg', 'piratenkleider') => 'http://www.piratepartei.lu/',
              '<img src="'.get_template_directory_uri().'/images/flags/ma.png" width="16" height="11" alt=""> '.__('Marokko', 'piratenkleider') => 'http://partipirate.ma/',
             ...
             '<img src="'.get_template_directory_uri().'/images/flags/ro.png" width="16" height="11" alt=""> '.__('Rum&auml;nien', 'piratenkleider') => 'http://www.partidulpiratilor.ro/',
             '<img src="'.get_template_directory_uri().'/images/flags/ru.png" width="16" height="11" alt=""> '.__('Russland', 'piratenkleider') => 'http://pirate-party.ru/',
             '<img src="'.get_template_directory_uri().'/images/flags/se.png" width="16" height="11" alt=""> '.__('Schweden', 'piratenkleider') => 'http://www.piratpartiet.se/',
             ...
             '<img src="'.get_template_directory_uri().'/images/flags/tn.png" width="16" height="11" alt=""> '.__('Tunesien', 'piratenkleider') => 'http://partipirate-tn.org/',
             '<img src="'.get_template_directory_uri().'/images/flags/tr.png" width="16" height="11" alt=""> '.__('T&uuml;rkei', 'piratenkleider') => 'http://www.korsanpartisi.org/',
             '<img src="'.get_template_directory_uri().'/images/flags/ua.png" width="16" height="11" alt=""> '.__('Ukraine', 'piratenkleider') => 'http://pp-ua.org/',
             '<img src="'.get_template_directory_uri().'/images/flags/uy.png" width="16" height="11" alt=""> '.__('Uruguay', 'piratenkleider') => 'http://partidopirata.org.uy/',
             '<img src="'.get_template_directory_uri().'/images/flags/us.png" width="16" height="11" alt=""> '.__('USA', 'piratenkleider') => 'http://pirate-party.us/',
             '<img src="'.get_template_directory_uri().'/images/flags/by.png" width="16" height="11" alt=""> '.__('Wei&szlig;russland', 'piratenkleider') => 'http://belpirat.blog.tut.by/',
             '<img src="'.get_template_directory_uri().'/images/flags/cy.png" width="16" height="11" alt=""> '.__('Zypern', 'piratenkleider') => 'http://www.piratepartycyprus.com/',
