 ...
 if ( $options['feed_twitter'] != "" ){
       ...
       $fetchlink = $defaultoptions['url-twitterapi'].'?screen_name='.$name.'&count='.$options['feed_twitter_numberarticle'];
        ...
        <div class="twitterwidget">
	        <hr>
             <h2><img src="<?php echo get_template_directory_uri(); ?>/images/social-media/twitter-24x24.png" width="24" height="24" alt=""><a href="https://twitter.com/<?php echo $name; ?>">Twitter - <?php echo $name; ?></a></h2>
