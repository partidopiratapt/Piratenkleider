...
<!--[if (gt IE 9)|!(IE)]><!--> <html <?php language_attributes(); ?>> <!--<![endif]-->
    ...
    <head>
        ...
        $cssadd = '';
        if (isset($options['css-default-header-height']) && ($options['css-default-header-height'] > 0) && ($options['css-default-header-height'] != $defaultoptions['css-default-header-height'])) {
            $cssadd .= '.header { height: ' . $options['css-default-header-height'] . 'px; }';
            $cssadd .= "\n";
        }
        if (isset($options['css-default-branding-padding-top']) && ($options['css-default-branding-padding-top'] > 0) && ($options['css-default-branding-padding-top'] != $defaultoptions['css-default-branding-padding-top'])) {
        ...
        <?php if ((isset($options['meta-description'])) && ( strlen(trim($options['meta-description'])) > 1 )) { ?>
        ...
        <script>
            jQuery(function() {
                jQuery(".bbp-the-content").sceditor({
                    plugins: "bbcode",
                    style: "<?php echo get_template_directory_uri(); ?>/css/jquery.sceditor.default.min.css",
                    resizeEnabled:false,
                    autoUpdate:true,
        ...
        <div class="section header">
            <div class="row">
                <div class="branding">
                        ...
                        <?php } ?>                                                             
                        <h1><img src="<?php header_image(); ?>" title="<?php bloginfo('name'); ?>"></h1>
                        ...
                        <div id="searchform">
                            ...
                            <form method="get" class="searchform" action="<?php echo home_url(); ?>/">
                                ...
                                <input type="text" value="<?php the_search_query(); ?>" name="s" id="s" placeholder="<?php _e("Suchbegriff eingeben", 'piratenkleider'); ?>"  
                                       onfocus="if (this.value == '<?php _e("Suchbegriff eingeben", 'piratenkleider'); ?>')
                        this.value = '';" onblur="if (this.value == '')
                        this.value = '<?php _e("Suchbegriff eingeben", 'piratenkleider'); ?>';" />
