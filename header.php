...
<!--[if (gt IE 9)|!(IE)]><!--> <html <?php language_attributes(); ?>> <!--<![endif]-->
    ...
    <head profile="http://gmpg.org/xfn/11">
        ...
        $cssadd = '';
        if (isset($designspecials['css-default-header-height']) && ($designspecials['css-default-header-height'] > 0) && ($designspecials['css-default-header-height'] != $defaultoptions['css-default-header-height'])) {
            $cssadd .= '.header { height: ' . $designspecials['css-default-header-height'] . 'px; }';
            $cssadd .= "\n";
        }
        if (isset($designspecials['css-default-header-background-color']) && (strlen($designspecials['css-default-header-background-color']) > 3)) {
            $cssadd .= '.header { background-color: ' . $designspecials['css-default-header-background-color'] . '; }';
            $cssadd .= "\n";
        }
        if (isset($designspecials['css-default-header-background-image']) && (strlen($designspecials['css-default-header-background-image']) > 2)) {
            $cssadd .= '.header { background-image: ' . $designspecials['css-default-header-background-image'] . '; }';
            $cssadd .= "\n";
        }
        if (isset($designspecials['css-default-header-background-position']) && (strlen($designspecials['css-default-header-background-position']) > 2)) {
            $cssadd .= '.header { background-position: ' . $designspecials['css-default-header-background-position'] . '; }';
            $cssadd .= "\n";
        }
        if (isset($designspecials['css-default-header-background-repeat']) && (strlen($designspecials['css-default-header-background-repeat']) > 2)) {
            $cssadd .= '.header { background-repeat: ' . $designspecials['css-default-header-background-repeat'] . '; }';
            $cssadd .= "\n";
        }

        if (isset($designspecials['css-default-branding-padding-top']) && ($designspecials['css-default-branding-padding-top'] > 0) && ($designspecials['css-default-branding-padding-top'] != $defaultoptions['css-default-branding-padding-top'])) {
...
<?php if ($options['defaultwerbesticker'] == "1") { ?>
                    ...
                    <div class="sticker">
                        <div class="skin">   
                            ...
                            <ul>
                                <?php
                                if (isset($options['stickerlink1-content']) && (strlen($options['stickerlink1-content']) > 1) && isset($options['stickerlink1-url']) && (strlen($options['stickerlink1-url']) > 5)) {
                                    echo '<li><a href="' . $options['stickerlink1-url'] . '">' . $options['stickerlink1-content'] . '</a></li>';
                                }
                                ?>
                                <?php
                                if (isset($options['stickerlink2-content']) && (strlen($options['stickerlink2-content']) > 1) && isset($options['stickerlink2-url']) && (strlen($options['stickerlink2-url']) > 5)) {
                                    echo '<li><a href="' . $options['stickerlink2-url'] . '">' . $options['stickerlink2-content'] . '</a></li>';
                                }
                                ?>
                                <?php
                                if (isset($options['stickerlink3-content']) && (strlen($options['stickerlink3-content']) > 1) && isset($options['stickerlink3-url']) && (strlen($options['stickerlink3-url']) > 5)) {
