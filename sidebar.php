 ...
 if ( $options['feed_twitter'] != "" ){
       ...
       $fetchlink = $defaultoptions['url-twitterapi'].'?screen_name='.$options['feed_twitter'].'&count='.$options['feed_twitter_numberarticle'];
        ...
        <div class="twitterwidget">
	        <hr>
                    <h2><img src="<?php echo get_template_directory_uri(); ?>/images/social-media/twitter-24x24.png" width="24" height="24" alt=""><a href="https://twitter.com/<?php echo $options['feed_twitter']; ?>">Twitter - <?php echo $options['feed_twitter']; ?></a></h2>
