...
<!--[if (gt IE 9)|!(IE)]><!--> <html <?php language_attributes(); ?>> <!--<![endif]-->
    ...
    <head>
        ...
        $cssadd = '';
        if (isset($designspecials['css-default-header-height']) && ($designspecials['css-default-header-height']
                > 0) && ($designspecials['css-default-header-height'] != $defaultoptions['css-default-header-height'])) {
            $cssadd .= '.header { height: ' . $designspecials['css-default-header-height'] . 'px; }';
            $cssadd .= "\n";
        }
        if (isset($designspecials['css-default-header-background-color']) && (strlen($designspecials['css-default-header-background-color'])
                > 3)) {
            $cssadd .= '.header { background-color: ' . $designspecials['css-default-header-background-color'] . '; }';
            $cssadd .= "\n";
        }
        if (isset($designspecials['css-default-header-background-image']) && (strlen($designspecials['css-default-header-background-image'])
                > 2)) {
            $cssadd .= '.header { background-image: ' . $designspecials['css-default-header-background-image'] . '; }';
            $cssadd .= "\n";
        }
        if (isset($designspecials['css-default-header-background-position']) && (strlen($designspecials['css-default-header-background-position'])
                > 2)) {
            $cssadd .= '.header { background-position: ' . $designspecials['css-default-header-background-position'] . '; }';
            $cssadd .= "\n";
        }
        if (isset($designspecials['css-default-header-background-repeat']) && (strlen($designspecials['css-default-header-background-repeat'])
                > 2)) {
            $cssadd .= '.header { background-repeat: ' . $designspecials['css-default-header-background-repeat'] . '; }';
            $cssadd .= "\n";
        }

        if (isset($designspecials['css-default-branding-padding-top']) && ($designspecials['css-default-branding-padding-top']
                > 0) && ($designspecials['css-default-branding-padding-top'] != $defaultoptions['css-default-branding-padding-top'])) {
        ...
        <?php if ((isset($options['meta-description']))
                && ( strlen(trim($options['meta-description'])) > 1 )) { ?>
            <meta name="description" content="<?php echo $options['meta-description'] ?>">
        <?php }
        if ((isset($options['meta-author'])) && ( strlen(trim($options['meta-author']))
                > 1 )) {
            ?>
            <meta name="author" content="<?php echo $options['meta-author'] ?>">
        <?php }
        if ((isset($options['meta-keywords'])) && ( strlen(trim($options['meta-keywords']))
                > 1 )) {
            ?>
...
<?php } ?>
        ...
        <?php
        if ((isset($designspecials['css-colorfile'])) && (strlen(trim($designspecials['css-colorfile']))
                > 1)) {
        ...
        if ((isset($designspecials['css-fontfile'])) && (strlen(trim($designspecials['css-fontfile']))
                > 1)) {
        ...
        if (( (isset($custom_fields['fullsize'])) && ($custom_fields['fullsize'][0]
                == true) && is_singular()) ||
                ((isset($options['position_sidebarbottom'])) && ($options['position_sidebarbottom']
                == 1))) {
        ...
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo get_template_directory_uri(); ?>/bbpress/css/bbpress.css">
...
?>
    ...
    <body <?php body_class(); ?>>
        ...
        <ul role="navigation" class="nav skiplinks">		
            <li><a class="ym-skip" href="#nav"><?php _e('Zur Navigation springen.',
        'piratenkleider'); ?></a></li>
            <li><a class="ym-skip" href="#main-content"><?php _e('Zum Inhalt springen.',
        'piratenkleider'); ?></a></li>
            <li><a class="ym-skip" href="#searchform"><?php _e('Zur Suche springen.',
                            'piratenkleider'); ?></a></li>
        </ul>
        ...
        <div class="section header">
            <div class="row">
                ...
                <div class="nav-top" role="navigation">				                                                        
                    <h2 class="skip"><?php _e('Service-Navigation',
                            'piratenkleider'); ?></h2>
...
?>
                ...
                <div class="nav-main" role="navigation" id="nav">
                    <h2 class="skip"><?php _e('Navigation',
        'piratenkleider'); ?></h2>
<?php
...
<?php } ?>
                ...
                <?php if ($options['defaultwerbesticker']
                        == "1") { ?>

                    <div class="sticker">
                        <div class="skin">   
                            <h2 class="skip"><?php _e('Sticker',
                        'piratenkleider'); ?></h2>                             
                            <ul>
                        <?php
                        if (isset($options['stickerlink1-content']) && (strlen($options['stickerlink1-content'])
                                > 1) && isset($options['stickerlink1-url']) && (strlen($options['stickerlink1-url'])
                                > 5)) {
                            echo '<li><a href="' . $options['stickerlink1-url'] . '">' . $options['stickerlink1-content'] . '</a></li>';
                        }
                        ?>
    <?php
    if (isset($options['stickerlink2-content']) && (strlen($options['stickerlink2-content'])
            > 1) && isset($options['stickerlink2-url']) && (strlen($options['stickerlink2-url'])
            > 5)) {
        echo '<li><a href="' . $options['stickerlink2-url'] . '">' . $options['stickerlink2-content'] . '</a></li>';
    }
    ?>
    <?php
    if (isset($options['stickerlink3-content']) && (strlen($options['stickerlink3-content'])
            > 1) && isset($options['stickerlink3-url']) && (strlen($options['stickerlink3-url'])
            > 5)) {
