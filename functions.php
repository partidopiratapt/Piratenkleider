...
function piratenkleider_scripts() {
    ...
    if ((($options['slider-aktiv'] == 1) && (is_home() || is_front_page())) || (($options['slider-aktiv'] == 1) && is_category() && ($options['category-startpageview'] == 1)) || ($options['slider-defaultwerbeplakate'] == 1) || ($options['aktiv-circleplayer'] == 1) || ($options['aktiv-dynamic-sidebar'] == 1 )) {
    ...
    wp_enqueue_script(
            'layoutjs', $defaultoptions['src-layoutjs'], array('myjquery'), $defaultoptions['js-version']
    );
    wp_enqueue_script(
            'yaml-focusfix', $defaultoptions['src-yaml-focusfix'], false, $defaultoptions['js-version']
    );
    ...
    if ($options['aktiv-dynamic-sidebar'] == 1) {
        wp_enqueue_script(
                'dynamic-sidebar', $defaultoptions['src-dynamic-sidebar'], array('myjquery'), $defaultoptions['js-version']
        );
    }

    if (is_singular() && ($options['aktiv-circleplayer'] == 1)) {
        wp_enqueue_script(
                'jplayer', $defaultoptions['src-jplayer'], array('myjquery'), $defaultoptions['js-version']
        );
        wp_enqueue_script(
...
if (!function_exists('get_piratenkleider_socialmediaicons')) :
    ...
    function get_piratenkleider_socialmediaicons($darstellung = 1) {
        ...
        if ($options['social_facebook'] != "") {
            echo '<li class="facebook"><a href="' . $options['social_facebook'] . '" target="blank"><img src="' . get_template_directory_uri() . '/images/social-media/facebook-24x24.png" width="24" height="24" alt="Facebook"></a></li>';
        }
        if ($options['social_twitter'] != "") {
            echo '<li class="twitter"><a href="' . $options['social_twitter'] . '" target="blank"><img src="' . get_template_directory_uri() . '/images/social-media/twitter-24x24.png" width="24" height="24" alt="Twitter"></a></li>';
        }
        if ($options['social_gplus'] != "") {
            echo '<li class="gplus"><a href="' . $options['social_gplus'] . '" target="blank"><img src="' . get_template_directory_uri() . '/images/social-media/gplus-24x24.png" width="24" height="24" alt="Google+"></a></li>';
        }
        if ($options['social_diaspora'] != "") {
            echo '<li class="diaspora"><a href="' . $options['social_diaspora'] . '" target="blank"><img src="' . get_template_directory_uri() . '/images/social-media/diaspora-24x24.png" width="24" height="24" alt="Diaspora"></a></li>';
        }
        if ($options['social_identica'] != "") {
            echo '<li class="identica"><a href="' . $options['social_identica'] . '" target="blank"><img src="' . get_template_directory_uri() . '/images/social-media/identica-24x24.png" width="24" height="24" alt="identi.ca"></a></li>';
        }
        if ($options['social_youtube'] != "") {
            echo '<li class="youtube"><a href="' . $options['social_youtube'] . '" target="blank"><img src="' . get_template_directory_uri() . '/images/social-media/youtube-24x24.png" width="24" height="24" alt="YouTube"></a></li>';
        }
        if ($options['social_itunes'] != "") {
            echo '<li class="itunes"><a href="' . $options['social_itunes'] . '" target="blank"><img src="' . get_template_directory_uri() . '/images/social-media/itunes-24x24.png" width="24" height="24" alt="iTunes"></a></li>';
        }
        if ($options['social_flickr'] != "") {
            echo '<li class="flickr"><a href="' . $options['social_flickr'] . '" target="blank"><img src="' . get_template_directory_uri() . '/images/social-media/flickr-24x24.png" width="24" height="24" alt="flickr"></a></li>';
        }
        if ($options['social_delicious'] != "") {
            echo '<li class="delicious"><a href="' . $options['social_delicious'] . '" target="blank"><img src="' . get_template_directory_uri() . '/images/social-media/delicious-24x24.png" width="24" height="24" alt="Delicious"></a></li>';
        }
        if ($options['social_flattr'] != "") {
            echo '<li class="flattr"><a href="' . $options['social_flattr'] . '" target="blank"><img src="' . get_template_directory_uri() . '/images/social-media/flattr-24x24.png" width="24" height="24" alt="Flattr"></a></li>';
        }
        if ($options['social_feed'] != "") {
            echo '<li class="feed"><a href="' . $options['social_feed'] . '" target="blank"><img src="' . get_template_directory_uri() . '/images/social-media/feed-24x24.png" width="24" height="24" alt="RSS/Atom-Feed"></a></li>';
        }
        echo '</ul>';
...
function wpi_linkexternclass_callback($matches) {
    $link = $matches[0];
    $site_link = home_url();
    if ((strpos($link, 'class') === false) && (strpos($link, 'mailto:') === false) && (strpos($link, $site_link) === false)) {
...
function piratenkleider_enqueue_styles() {
    ...
    if (($options['1april-prank'] == 1) && (date('m-d') == $options['1april-prank-day'])) {
        wp_register_style('1april-css', $options['1april-css']);
        wp_enqueue_style('1april-css');
    } else {
        if ((isset($designspecials['css-colorfile'])) && (strlen(trim($designspecials['css-colorfile'])) > 1)) {
            wp_register_style('css-colorfile', get_template_directory_uri() . '/css/' . $designspecials['css-colorfile']);
            wp_enqueue_style('css-colorfile');
        }
    }
    ...
    if (is_singular() && ($options['aktiv-circleplayer'] == 1)) {
        wp_register_style('aktiv-circleplayer', get_template_directory_uri() . '/css/circle.player.css');
        wp_enqueue_style('aktiv-circleplayer');
    }
    wp_register_style('bp', get_template_directory_uri() . '/css/bp.css');
    wp_register_style('bbp', get_template_directory_uri() . '/css/bbpress.css');
    wp_enqueue_style('bp');
    wp_enqueue_style('bbp');
}
