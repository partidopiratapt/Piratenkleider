...
if (bp_has_profile('profile_group_id=' . bp_get_current_profile_group_id())) :
    while (bp_profile_groups()) : bp_the_profile_group();
        ...
        <?php bp_profile_group_tabs(); ?>
            ...
            <?php
            $forum_signature = get_the_author_meta("_forum_signature", $bp->loggedin_user->id);
            wp_editor($forum_signature, '_forum_signature', array('tinymce' => true, 'media_buttons' => false, 'textarea_rows' => 5));
            ?>
